...
const wchar_t kRegPathClients[] = L"Software\\Falcon\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\Falcon\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\Falcon\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\Falcon\\Update";
