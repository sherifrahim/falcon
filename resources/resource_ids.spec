...
# This would currently put the end of our strings at ~58,000.
{
  ...
  "<(SHARED_INTERMEDIATE_DIR)/brave/web-ui-falcon_control/falcon_control.grd": {
    "META": {"sizes": {"includes": [10]}},
    "includes": [54190],
  },
  "<(SHARED_INTERMEDIATE_DIR)/brave/web-ui-falcon_command_deck/falcon_command_deck.grd": {
    "META": {"sizes": {"includes": [10]}},
    "includes": [54200],
  },
  "<(SHARED_INTERMEDIATE_DIR)/brave/web-ui-falcon_collections/falcon_collections.grd": {
    "META": {"sizes": {"includes": [10]}},
    "includes": [54210],
  },
