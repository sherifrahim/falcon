...
export function DownloadRow({ d, client, open, onToggle, refresh, setError }: Props) {
  ...
  return (
    <Row $open={open}>
      ...
      <Actions>
        ...
        {path && <Button $small onClick={() => chrome.send('falcon_downloader.openFolder', [path])}>Folder</Button>}
        {live ? (
